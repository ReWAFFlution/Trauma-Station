...
description: Component-specific ECS guidance for {FORK_NAME} SS14 work. Use when adding, moving, networking, serializing, reviewing, or refactoring components, DataFields, access restrictions, ProtoId fields, and component examples.
---
...
4. Put new {FORK_NAME} components under the relevant `{FORK_DIR}` assembly path.
