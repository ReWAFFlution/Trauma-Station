...
description: Sprite, RSI, icon, appearance visualizer, overlay, shader, displacement map, and rendering guidance for SS14 {FORK_NAME} work. Use when changing visuals, dynamic sprites, GenericVisualizer, overlays, textures, or shader resources.
---
...
- Put new {FORK_NAME} textures under `Resources/Textures/{FORK_DIR}`.
