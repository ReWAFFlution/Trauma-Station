...
Never edit `RobustToolbox/**`. New SS14-ART-CORE code belongs in `_Art`. Any edit outside `_Art` needs a tight Art-Edit marker block. Prefer SS14 ECS, prediction, localization, typed data, and .NET 10-current APIs.
